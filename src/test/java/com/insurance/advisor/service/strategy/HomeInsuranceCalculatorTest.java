...
public class HomeInsuranceCalculatorTest {
    ...
    public HomeCalculator homeCalculator;
    ...
    @Test
    @DisplayName("Calculate Home Insurance")
    public void When_Valid_Data_Then_Return_EconomicScore() {
        Assertions.assertEquals(Score.ECONOMIC.getName(), insurance.getScore());
    }
}